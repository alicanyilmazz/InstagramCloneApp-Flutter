...
import 'package:flutter_sample/core/constant/images/image_constant.dart';
...
class SampleRegisterScren extends StatelessWidget {
  ...
  AnimatedContainer buildAnimatedContainer(BuildContext context) {
    return AnimatedContainer(
        ...
        color: Colors.white,
        child: Center(child: Image.asset(ImageConstants.instance.piano)));
  }
